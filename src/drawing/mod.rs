...
impl Renderer
{
    pub fn create(width: i32, height: i32, title: &str) -> Renderer {
        let input_handler =
    ...
    pub fn change_input_handler(&mut self, handler: std::rc::Rc<std::cell::RefCell<dyn InputHandler>>) {
        match &self.input_handler {
            Some(i) => {
                std::mem::drop(i);
...
pub fn create_backend(
    ...
    Renderer::create(width, height, title)
}
