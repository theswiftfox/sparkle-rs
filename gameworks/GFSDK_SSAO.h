...
#define GFSDK_SSAO_DECL(RETURN_TYPE, FUNCTION_NAME, ...)     \
    typedef RETURN_TYPE (*PFN_##FUNCTION_NAME)(__VA_ARGS__); \
    extern PFN_##FUNCTION_NAME FUNCTION_NAME
...
{
    GFSDK_SSAO_Version()
        : Major(4), Minor(0), Branch(0), Revision(23827312)
    {
    }
...
struct GFSDK_SSAO_InputViewport
{
    ...
    GFSDK_SSAO_InputViewport()
        : Enable(false), TopLeftX(0), TopLeftY(0), Width(0), Height(0), MinDepth(0.f), MaxDepth(1.f)
    {
    }
};
...
struct GFSDK_SSAO_InputDepthData
{
    ...
    GFSDK_SSAO_InputDepthData()
        : DepthTextureType(GFSDK_SSAO_HARDWARE_DEPTHS), MetersToViewSpaceUnits(1.f)
    {
    }
};
...
struct GFSDK_SSAO_InputNormalData
{
    ...
    GFSDK_SSAO_InputNormalData()
        : Enable(false), DecodeScale(1.f), DecodeBias(0.f)
    {
    }
};
...
struct GFSDK_SSAO_ForegroundAO
{
    ...
    GFSDK_SSAO_ForegroundAO()
        : Enable(false), ForegroundViewDepth(0.f)
    {
    }
};
...
struct GFSDK_SSAO_BackgroundAO
{
    ...
    GFSDK_SSAO_BackgroundAO()
        : Enable(false), BackgroundViewDepth(0.f)
    {
    }
};
...
struct GFSDK_SSAO_DepthThreshold
{
    ...
    GFSDK_SSAO_DepthThreshold()
        : Enable(false), MaxViewDepth(0.f), Sharpness(100.f)
    {
    }
};
...
struct GFSDK_SSAO_BlurSharpnessProfile
{
    ...
    GFSDK_SSAO_BlurSharpnessProfile()
        : Enable(false), ForegroundSharpnessScale(4.f), ForegroundViewDepth(0.f), BackgroundViewDepth(1.f)
    {
    }
};
...
struct GFSDK_SSAO_BlurParameters
{
    ...
    GFSDK_SSAO_BlurParameters()
        : Enable(true), Radius(GFSDK_SSAO_BLUR_RADIUS_4), Sharpness(16.f)
    {
    }
};
...
struct GFSDK_SSAO_Parameters
{
    ...
    GFSDK_SSAO_Parameters()
        : Radius(1.f), Bias(0.1f), SmallScaleAO(1.f), LargeScaleAO(1.f), PowerExponent(2.f), StepCount(GFSDK_SSAO_STEP_COUNT_4), DepthStorage(GFSDK_SSAO_FP16_VIEW_DEPTHS), DepthClampMode(GFSDK_SSAO_CLAMP_TO_EDGE), EnableDualLayerAO(false)
    {
    }
};
...
struct GFSDK_SSAO_CustomBlendState_D3D12
{
    ...
    GFSDK_SSAO_CustomBlendState_D3D12()
        : pBlendState(NULL), pBlendFactor(NULL)
    {
    }
};
...
struct GFSDK_SSAO_CustomDepthStencilState_D3D11
{
    ...
    GFSDK_SSAO_CustomDepthStencilState_D3D11()
        : pDepthStencilState(NULL), StencilRef(0)
    {
    }
};
